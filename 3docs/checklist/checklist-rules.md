Checklist items should be in the form - [ ] {item}. When they are in progress, you should mark them as [PROGRESS] {item}. When they are finished, they should be marked [x] {item}.
